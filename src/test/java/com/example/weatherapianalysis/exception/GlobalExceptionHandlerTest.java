package com.example.weatherapianalysis.exception;

import com.example.weatherapianalysis.base.AbstractRestControllerTest;
import com.example.weatherapianalysis.exception.error.CustomError;
...
class GlobalExceptionHandlerTest extends AbstractRestControllerTest {
    ...
    @Test
    void givenObjectError_whenHandleMethodArgumentNotValid_thenRespondWithBadRequest() {
